        ...
        <div className="flex flex-col sm:flex-row gap-6 mb-6">
          ...
          <div className="flex-1 grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            <div>
              ...
              {isEditing
                ? <input type="email" defaultValue="arjun.reddy@viziito.com" className="w-full bg-slate-50 border border-slate-200 rounded-xl px-3 py-2 text-sm font-medium text-slate-900 focus:outline-none focus:ring-2 focus:ring-teal-500/20 focus:border-teal-400" />
                : <ReadField value="arjun.reddy@viziito.com" badge="verified" />
              }
            </div>
            <div>
